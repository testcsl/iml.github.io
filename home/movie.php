...
$query_Recordset2 = sprintf("SELECT * FROM diany WHERE id = %s", GetSQLValueString($colname_Recordset2, "int"));
$Recordset2 = mysql_query($query_Recordset2, $test2) or die(mysql_error());
...
<article>
  <div class="container">
    <h1 align="center" style="line-height:36px;"><?php echo $row_Recordset2['biaoti']; ?></h1>
    <p align="center" style="line-height:36px;"><?php echo $row_Recordset2['shijian']; ?></p>
    <p align="center" style="line-height:36px;"><?php echo $row_Recordset2['dizhi']; ?></p>
    <p align="center" style="line-height:36px;">&nbsp;</p>
    <p align="center" style="line-height:36px;"><?php echo $row_Recordset2['zhengwen']; ?></p>
<div>
</div>
    <h2 class="ctitle">&nbsp;</h2>
<style>

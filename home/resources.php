...
$query_Recordset1 = sprintf("SELECT * FROM zuix WHERE id = %s", GetSQLValueString($colname_Recordset1, "int"));
...
mysql_select_db($database_test2, $test2);
$query_Recordset3 = "SELECT * FROM test";
...
<article>
  <div class="leftbox">
    <div class="infos">
      <div class="newsview">
        ...
        <?php do { ?>
          <h3 class="news_title"><?php echo $row_Recordset1['biaoti']; ?></h3>
          ...
          <div class="news_about"><strong>简介</strong><?php echo $row_Recordset1['jianjie']; ?></div>
          <div class="news_infos">
            <p><?php echo $row_Recordset1['zhengwen']; ?></p>
          </div>
  ...
  <div class="rightbox">
    ...
    <div class="paihang">
      <h2 class="ab_title">电影</h2>
      <ul>
        <?php do { ?>
          <li><a href="movie sharing.php?id=<?php echo $row_Recordset2['id']; ?>"><b><?php echo $row_Recordset2['biaoti']; ?></b>
            </a>
            <p><a href="movie sharing.php"><?php echo $row_Recordset2['jianjie']; ?></a></p>
          </li>

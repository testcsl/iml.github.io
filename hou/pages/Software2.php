...
$query_Recordset1 = "SELECT * FROM zuix";
                                ...
                                <tbody>
                                 <?php do { ?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="center"><a href="txt.php?id=<?php echo $row_Recordset1['id']; ?>&cate=<?php echo $row_Recordset1['flmz']; ?>">修改</a> <a href="shanchu.php?id=<?php echo $row_Recordset1['id']; ?>&cate=<?php echo $row_Recordset1['flmz']; ?>&yem=Software2">删除</a></td>
                                    </tr>

...
$query_Recordset1 = "SELECT * FROM diany";
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td><?php echo $row_Recordset1['biaoti']; ?></td>
                                        <td><?php echo $row_Recordset1['flmz']; ?></td> 
                                        <td class="center"><a href="txt.php?id=<?php echo $row_Recordset1['id']; ?>&cate=<?php echo $row_Recordset1['flmz']; ?>">修改</a> <a onClick="if(confirm('真滴要删除吗？')===true){return true;}return false" href="shanchu.php?id=<?php echo $row_Recordset1['id']; ?>&cate=<?php echo $row_Recordset1['flmz']; ?>&yem=Film">删除</a></td>

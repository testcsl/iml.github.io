...
<head>
    ...
    <style type="text/css">
    #wrapper #page-wrapper .row .col-lg-12 .page-header {
	font-family: 宋体;
}
    </style>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php"><em>帅</em></a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                      <li>
                          <a href="index.php"><i class="fa fa-table fa-fw"></i>首页</a>
                        </li>
                         <li>
                            <a href="Software.php"><i class="fa fa-table fa-fw"></i>软件</a>
                        </li>
                         <li>
                            <a href="/test2/hou/pages/Software2.php"><i class="fa fa-table fa-fw"></i>最新软件</a>
                        </li>
                         <li>
                         ...
                         <li>
                            <a href="Software.php"><i class="fa fa-table fa-fw"></i>文章添加</a>
                        </li>
                        <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">小陈哥哥的博客</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->

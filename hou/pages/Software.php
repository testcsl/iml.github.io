                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody> <?php do { ?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="center"><a href="txt.php?id=<?php echo $row_Recordset1['id']; ?>&cate=<?php echo $row_Recordset1['flmz']; ?>">修改</a> <a href="shanchu.php?id=<?php echo $row_Recordset1['id']; ?>&cate=<?php echo $row_Recordset1['flmz']; ?>&yem=Software">删除</a></td>
